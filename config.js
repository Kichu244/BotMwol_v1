...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By BOTMWOL' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '꧁༒☬ʙᴏᴛᴍᴡᴏʟ_ᴠ1☬༒꧂' : process.env.BOT_NAME,
    ...
    TALKING_BOTMWOL: process.env.TALKING_BOTMWOL === undefined ? 'false' : process.env.TALKING_BOTMWOL,
    ...
    YAK: process.env.YAK === undefined ? '918547487332,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
